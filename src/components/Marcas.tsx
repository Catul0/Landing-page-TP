...
const Marcas = () => {
  return (
    <>
      <div className='hidden lg:flex px-24 2xl:px-[350px] mt-16 pt-8 place-items-center place-content-around'>
      ...
      <div className="flex flex-row lg:hidden px-24 2xl:px-[350px] mt-16 pt-8 place-items-center">
      ...
      <div className="flex flex-row lg:hidden px-24 2xl:px-[350px] mt-8 pt-8 place-items-center">
