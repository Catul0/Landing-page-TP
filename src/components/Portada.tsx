        ...
        <div className=" mt-8 pt-16  " id="portada">
            <section className="lg:hidden">
                ...
                <div className=" bg-white rounded-b lg:rounded-b-none lg:rounded-r p-4 pt-4 flex flex-col justify-between leading-normal">
                        <div className="mb-8">
                            <div className="text-gray-900 font-bold text-[30px] mb-2">Want anything to be easy with <b>LaslesVPN.</b></div>
                            <p className="text-gray-700 text-[18px]">Provide a network for all your needs with ease and fun using <b>LaslesVPN</b> discover interesting features from us.</p>
                        </div>
